    ...
    for key in red_light_queues:
        if key in current_light:
            for element in red_light_queues[key]:
                ...
                queues_col.insert_one(element)  # Insert into queues_col
                if "alert" in element and element["alert"] == "Red light runner!":
                    red_light_runners_col.insert_one(element)  # Insert into red_light_runners_col
...
def generate_traffic():
    ...
    while True:
        ...
        if traf_type == "Vehicle":
            ...
            # Check if speed is more than 11+ mph over limit
